...
describe("CryptoUtils", () => {
  ...
  describe("hexToBase64", () => {
    it("debería convertir hexadecimal a Base64 correctamente", () => {
      // hex: 48656c6c6f → "Hello"
      const result = utils.hexToBase64("48656c6c6f");
      expect(result).toBe("SGVsbG8="); // "Hello" en Base64
    });
  });

  describe("bigint3base64", () => {
    it("debería convertir bigint a Base64 con saltos de línea cada 76 caracteres", () => {
      const bigint = BigInt("12345678901234567890");
      const result = utils.bigint3base64(bigint);
